...
export default function Page() {
  return (
    <>
      <Head>
        <title>Create an account - StashBlob</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Create an account - StashBlob" />
        <meta
        ...
        />
        <meta name="twitter:title" content="Create an account - StashBlob" />
        <meta
