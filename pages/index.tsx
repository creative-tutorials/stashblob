  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="App | StashBlob" />
        <meta
        ...
        />
        <meta name="twitter:title" content="App | StashBlob" />
        <meta
      ...
      <div>
        ...
        {isLoading && (
          <div className="w-full h-full fixed top-0 left-0 bg-thirdprop/60 backdrop-blur-md flex items-center justify-center">
            <OvalLoader />
          </div>
        )}
      </div>
